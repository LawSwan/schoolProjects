"""
Main Entry Point for GitHub Archive SQLite CRUD Application
...
def main():
    ...
    print("=" * 60)
    print("  GitHub Archive SQLite CRUD Application")
    print("=" * 60)
    ...
    try:
        ...
        print("Thank you for using GitHub Archive SQLite CRUD!\n")
        sys.exit(0)
