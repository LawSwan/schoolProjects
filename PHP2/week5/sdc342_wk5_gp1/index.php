...
if (isset($_POST['create'])) {
 ...
 if (empty($fName)) {
     echo "<p style='color: orange;'>Error: No filename provided!</p>";
 } else {
     $result = FileUtilities::WriteFile($dir . $fName, $content);
     if ($result) {
         echo "<p style='color: green;'>File '$fName' created successfully!</p>";
     } else {
         echo "<p style='color: red;'>Failed to create file '$fName'.</p>";
     }
 }
...
<html>
<head>
 <title>Week5 GP1 - Amber Lawson</title>
</head>
<body>
 <h1>Week5 GP1 - Amber Lawson</h1>
